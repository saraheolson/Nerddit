...
import com.nerdery.solson.dependencyinjection.modules.AndroidModule;
...
public class NerdditApplication extends Application {

    private static NerdditApplication sInstance;
     ...
     */
    public static NerdditApplication getInstance() {
        return sInstance;
    }
